    ...
    <div class="min-h-screen ">
        ...
        <main>
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 px-2">
                ...
                <form enctype="multipart/form-data" action="{{ route('account.update', $user->id) }}" method="POST" class="gap-8">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-1 gap-4 w-1/2">
                        ...
                        <div class="flex gap-2">
                            <button class="justify-center w-1/2 mt-2 text-white p-2 rounded-md"
                                style="background-color:#d0c05B">
                                {{ __('Submit') }}
                            </button>
                            <a href="/account" class="justify-center w-full mt-2 text-white p-2 rounded-md bg-green-500 text-center">
                                <button >
                                    {{ __('Back') }}
                                </button>
                            </a>
